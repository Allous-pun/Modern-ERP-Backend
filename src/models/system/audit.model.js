...
const auditSchema = new mongoose.Schema({
    ...
    action: {
        ...
        enum: [
            ...
            'deactivate_organization', 'update_subscription', 'update_settings',
            ...
            // Report actions
            'publish',           // For publishing reports
            'feedback',          // For report feedback
            'generate',          // For generating reports
            'schedule',          // For scheduling reports
            'download',          // For downloading reports
            'post',		 // For posting journal entries to ledger
