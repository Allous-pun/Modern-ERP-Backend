    ...
    // ========== 2. EXECUTIVE & STRATEGIC MANAGEMENT ==========
    {
        ...
        features: [
            ...
            { 
                ...
                key: 'supply_chain', 
                description: 'Supply chain metrics and analytics',
                roles: ['coo', 'ceo']
            },
        
            // CFO Features - Enhanced with your requested additions
            { 
                name: 'Financial Oversight', 
                key: 'financial_oversight', 
                description: 'Financial performance dashboards and forecasts',
                roles: ['cfo', 'ceo', 'finance_director']
            },
            { 
                name: 'Treasury Management', 
                key: 'treasury_management', 
                description: 'Cash management, investments, and debt tracking',
                roles: ['cfo', 'treasurer']
            },
            { 
                name: 'Tax Management', 
