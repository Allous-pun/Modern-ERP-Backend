...
const systemRoutes = require('./routes/system');  // system/index.js
const securityRoutes = require('./routes/security.routes');
// const executiveRoutes = require('./routes/executive.routes'); // REMOVED - using folder structure instead
const executiveRoutes = require('./routes/executive'); // ADDED - points to executive/index.js
...
app.use('/api/system', systemRoutes);  // Points to system/index.js
app.use('/api/executive', executiveRoutes); // Points to executive/index.js
